...
/*void printMyFutureString() async {
  ...
  final TextEditingController _prixController = TextEditingController();
    final TextEditingController _typeTransController = TextEditingController();
     TextEditingController _id_caController = ListView();
  ...
  void _showForm(int  id) async {
    if (id != null) {
      ...
      _typeTransController.text =existingJournal['typeTrans']; 
      _id_caController.ListView=existingJournal['id_cat'];
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(
                ...
                controller: _typeTransController,
                decoration: const InputDecoration(hintText: 'Type Transactions'),
              ),
               const SizedBox(
                height: 20,
              ), TextField(
...
// Insert a new journal to the database
  Future<void> _addItem() async {
    await  dbHelper.createTran(
        _nameController.text, _descriptionController.text,_prixController.text,_typeTransController.text, );
    _refreshJournals();
  }
  ...
  Future<void> _updateItem(int id) async {
    await dbHelper.updateTran(
        id,_nameController.text, _descriptionController.text,_prixController.text,_typeTransController.text,);
    _refreshJournals();
  }
