  ...
  _onCreate(Database db, int intVersion) async {
     await db.execute(" CREATE TABLE  categorie ("
        ...
        ")");
         ...
         "typeTrans Text ,"
         "id_ca INTEGER ,"
         "FOREIGN KEY(id_ca) REFERENCES categorie(id_cat)"
        ")");
...
/*** */
   ...
   Future<int> createTran(String name, String descrption, String prix,String typeTrans, int id_ca) async {
    //final db = await DbHelper.bd();
  var dbClient = await db;
    final data = {'name': name, 'description': descrption, 'prix': prix,'typeTrans':typeTrans,'id_cat':id_ca};
   ...
   Future<int> saveTran(Transactions transactions) async {
    ...
    Future<int> updateTran(
      int id, String name, String descrption,String prix,String typeTrans, int id_ca) async {
